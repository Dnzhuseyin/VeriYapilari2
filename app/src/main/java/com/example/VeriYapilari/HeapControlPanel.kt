    ...
    Card(
        ...
        Column(
            ...
            Card(
                ...
                Row(
                    ...
                    OutlinedTextField(
                        ...
                        modifier = Modifier
                            .weight(1f)
                            .tutorialTarget("heap_input_field", onPositionChanged),
                        singleLine = true,
                    ...
                    Card(
                        modifier = Modifier
                            .size(48.dp)
                            .tutorialTarget("heap_add_button", onPositionChanged),
                        shape = RoundedCornerShape(12.dp),
                        colors = CardDefaults.cardColors(
                    ...
                    Card(
                        modifier = Modifier
                            .size(48.dp)
                            .tutorialTarget("heap_delete_button", onPositionChanged),
                        shape = RoundedCornerShape(12.dp),
                        colors = CardDefaults.cardColors(
                            containerColor = if (inputValue.isNotBlank())
            ...
            Button(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .tutorialTarget("heap_extract_button", onPositionChanged),
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedButton(
                    ...
                    modifier = Modifier
                        .weight(1f)
                        .tutorialTarget("heap_zoom_in", onPositionChanged),
                    shape = RoundedCornerShape(12.dp)
                ) {
                ...
                OutlinedButton(
                    ...
                    modifier = Modifier
                        .weight(1f)
                        .tutorialTarget("heap_zoom_out", onPositionChanged),
                    shape = RoundedCornerShape(12.dp)
                ) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                OutlinedButton(
                    ...
                    modifier = Modifier
                        .weight(1f)
                        .tutorialTarget("heap_reset_zoom", onPositionChanged),
                    shape = RoundedCornerShape(12.dp)
                ) {
                ...
                Button(
                    ...
                    modifier = Modifier
                        .weight(1f)
                        .tutorialTarget("heap_clear", onPositionChanged),
                    colors = ButtonDefaults.buttonColors(
